Kmcoin Core version *0.15.1* is now available from:

  <https://download.kmcoin.org/kmcoin-0.15.1/>
...
A number of changes to the way Kmcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 kths per kB (0.00001 KTH). This is to prepare for dropping the minimum transaction fee to 0.1 kths per kB (0.0001 KTH) in the next release.
