...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kmcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kmcoin transaction") + "\n" +
              "  kmcoin-tx [options] -create [commands]   " + _("Create hex-encoded kmcoin transaction") + "\n" +
              "\n";
