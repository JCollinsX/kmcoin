...
{
    const char* pszTimestamp = "I have one nephew 19/Jul/2021 for kmcoin";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1626670812, 2084820399, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // vSeeds.emplace_back("seed-a.kmcoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.kmcointools.com", true);
        // vSeeds.emplace_back("dnsseed.kmcoinpool.org", true);
        ...
        chainTxData = ChainTxData{
            ...
            1626670812, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.kmcointools.com", true);
        vSeeds.emplace_back("seed-b.kmcoin.loshan.co.uk", true);
