...
const char * const BITCOIN_CONF_FILENAME = "kmcoin.conf";
const char * const BITCOIN_PID_FILENAME = "kmcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kmcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kmcoin";
#else
    // Unix
    return pathRet / ".kmcoin";
#endif
#endif
}
