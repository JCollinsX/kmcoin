...
#if defined(NDEBUG)
# error "Kmcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kmcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KTH additional fees, %d delta bytes\n",
